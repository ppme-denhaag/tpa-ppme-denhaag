...
| GET | `/.netlify/functions/streak-status` | Not built (ADR-015 part 2b) |
...
**Implementation status.** Every event-driven notification is live as of
ADR-015 part 2a. What remains is the four scheduled ones (part 2b):
...
| Homework due tomorrow | Deferred to part 2b (scheduled Function `homework-due-reminders`) |
...
| Daily Murajaah reminder | Deferred to part 2b (scheduled Function `send-murajaah-reminders`) |
...
family's parent received nothing.
